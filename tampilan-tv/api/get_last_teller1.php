<?php
// Return last called Teller 1 number for today (cabang 12 only)
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  // Use 'bagian' column to identify teller assignment (1 = Teller 1)
  $sql = "SELECT no_antrian_teller FROM tbl_antrian_teller 
    WHERE tanggal_teller='$tanggal' AND status_teller IN ('1','2') AND cabang_id='$cabang_id' AND bagian='1'
