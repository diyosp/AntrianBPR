...
<body class="d-flex flex-column h-100" style="background-color: #081941;">
    ...
    <div class="container pt-5">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 rounded-2 shadow-sm" style="background-color: #11224E;">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2" style="color: #fff;">Panggilan Antrian Customer Service</h1>
        </div>
        <!-- breadcrumbs -->
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0" style="color: #fff;">Jumlah Antrian Customer Service</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card border-0 shadow-sm" style="background-color: #11224E;">
        <div class="card-body p-4">
          <div class="table">
            <table id="tabel-antrian" class="table table-bordered table-striped table-hover" width="100%" style="color: #fff;">
              <thead>
                <tr>
  ...
  <style>
    ...
    #tabel-antrian tbody tr {
      color: #fff !important;
    }
    #tabel-antrian tbody tr td {
      color: #fff !important;
    }
    #tabel-antrian tbody tr:hover {
      color: #fff !important;
    }
    ...
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        if (action === 'start') {
          ...
          $('#modal-no-antrian').text(data["no_antrian"]);
